...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="font-medium">C++, Next.js, Node.js, and MongoDB</span> and
        have experience working with <span className="font-medium">TypeScript</span>{" "}and <span className="font-medium">Prisma.</span>{" "}
        <span className="italic">Problem-solving is what excites me the most</span>{" "}
        about programming — I <span className="underline">love</span> that <span className="font-medium">"aha" </span>
        ...
        <span className="font-medium">internship </span>or <span className="font-medium">full-time opportunities</span> in
  ...
  up on <span className="font-medium">AI concepts </span>and <span className="font-medium">cloud computing.</span>
      </p>
    </motion.section>
  );
}
